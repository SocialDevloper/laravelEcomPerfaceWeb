  ...
  <table class="table table-striped table-sm">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="white-space: nowrap;"><a class="btn btn-info btn-sm" href="{{route('admin.profile.recover',$user->id)}}">Restore</a> | <a class="btn btn-danger btn-sm" href="javascript:;" onclick="confirmDelete('{{$user->id}}')">Delete</a>
        ...
        <td style="white-space: nowrap;"><a class="btn btn-info btn-sm" href="{{route('admin.profile.edit',$user->id)}}">Edit</a> | <a id="trash-user-{{$user->id}}" class="btn btn-warning btn-sm" href="{{route('admin.profile.remove',$user->id)}}">Trash</a> | <a class="btn btn-danger btn-sm" href="javascript:;" onclick="confirmDelete('{{$user->id}}')">Delete</a>
